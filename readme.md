...
| [A\&B BNN: Add\&Bit-Operation-Only Hardware-Friendly Binary Neural Network](https://) | arXiv preprint arXiv:2403.03739 | [Link](#) |  |
| [Ulit-BiDet: An Ultralightweight Object Detector for SAR Images Based on Binary Neural Networks](https://) | IEEE Transactions on Geoscience and Remote Sensing | [Link](#) |  |
| [BiPer: Binary Neural Networks using a Periodic Function](https://) | arXiv preprint arXiv:2404.01278 | [Link](#) |  |
| [FBPT: A Fully Binary Point Transformer](https://) | arXiv preprint arXiv:2403.09998 | [Link](#) |  |
| [Taming binarized neural networks and mixed-integer programs](https://) | Proceedings of the AAAI Conference on Artificial Intelligence | [Link](#) |  |
| [Training of binary neural network models using continuous approximation](https://) | Sixteenth International Conference on Machine Vision (ICMV 2023) | [Link](#) |  |
| [Distilled non-semantic speech embeddings with binary neural networks for low-resource devices](https://) | Pattern Recognition Letters | [Link](#) |  |
...
| [Diluted binary neural network](https://) | Pattern Recognition | [Link](#) |  |
| [LAB: learnable activation binarizer for binary neural networks](https://) | Proceedings of the IEEE/CVF Winter Conference on Applications of Computer Vision | [Link](#) |  |
| [Optimizing data-flow in Binary Neural Networks](https://) | arXiv preprint arXiv:2304.00952 | [Link](#) |  |
...
| Title | Venue | Link | Code Link |
|:------|:------|:----:|:----:|
| [BoolNet: Towards Energy-Efficient Binary Neural Networks Design and Optimization](https://) | 2nd Workshop on Sustainable AI | [Link](#) |  |
